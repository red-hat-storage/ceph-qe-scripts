...
class MakeMachine(object):
    ...
    def get_osds(self):
        ...
        osd1 = Machines('x.x.x.63', 'hostname')
        osd2 = Machines('x.x.x.64', 'hostname')
    ...
    def get_mons(self):
        ...
        mon1 = Machines('x.x.x.63', 'hostname')
        mon2 = Machines('x.x.x.64', 'hostname')
    ...
    def get_admin(self):
        ...
        admin_node = Machines('x.x.x.14', 'hostname')
        return admin_node
