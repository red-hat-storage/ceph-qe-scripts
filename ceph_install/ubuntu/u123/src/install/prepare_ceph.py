...
class PrepareCeph(object):
    ...
    def add_osds(self):
        ...
        for each in self.osds:
            hostname_with_disk.append(each.hostname + ':/dev/sdb' +
                                      '  ' + each.hostname + ':/dev/sdc' +
                                      '  ' + each.hostname + ':/dev/sdd')
    ...
    def create_pool(self):
        ...
        self.create_pool_cmd = 'sudo ceph osd pool create mypool 512 512 replicated replicated_ruleset'
