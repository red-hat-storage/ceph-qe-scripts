...
class EnableRepos(object):
    ...
    def enable_rhel_repo(self):
        ...
        self.attach_poolid = " 'sudo subscription-manager attach --pool=%s' " % (
            self.poolid
        )
        self.enable_repo = (
...
class DoAdminSettings(object):
    ...
    def do_settings(self):
        ...
        add_repos = EnableRepos(
            self.admin_nodes, self.qa_username, self.qa_password, self.pool_id
        )
        add_repos.execute()
