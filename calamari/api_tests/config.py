...
def get_config():
    ...
    try:
        ...
        log.info('--------------------')
        info_response = c.request('GET', 'info')
        ...
        log.info('--------------------')
        user_response = c.request('GET', 'user')
        ...
        log.info('api grains list')
        log.info('--------------------')
        response_grains = c.request('GET', 'grains')
        ...
        cluster_id_response = c.request('GET', cluster_with_fsid_api)
