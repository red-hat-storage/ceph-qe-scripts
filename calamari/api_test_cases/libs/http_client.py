...
class HTTPRequest(AuthenticateClient):
    ...
    def post(self, url, data):
        ...
        response = self.client.post(url, data=data, verify=False, headers=self.headers)
    ...
    def patch(self, url, data):
        ...
        response = self.client.patch(url, data, verify=False, headers=self.headers)
    ...
    def delete(self, url):
        ...
        response = self.client.delete(url, verify=False, headers=self.headers)
