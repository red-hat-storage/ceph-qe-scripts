...
class MakeMachine(object):
    ...
    def get_osds(self):
        ...
        osd1 = Machines('10.8.128.63', 'magna063')
    ...
    def get_mons(self):
        ...
        mon1 = Machines('10.8.128.63', 'magna063')
        mon2 = Machines('10.8.128.64', 'magna064')
    ...
    def get_admin(self):
        ...
        admin_node = Machines('10.8.128.14', 'magna014')
        return admin_node
...
class Marshall(object):
    ...
    def __init__(self):
        ...
        self.username = 'inktank'  # uesername from inktank
        self.password = 'TGwNwH.M-wgnU-15GAmf'  # password from inktank
