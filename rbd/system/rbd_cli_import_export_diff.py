...
export_format_parameters_2 = {
    "export_format_parameters": {"null": {"arg": " ", "val": " "}}
}

export_format_parameters_3 = {
    "export_format_parameters": {
        "null": {"arg": " ", "val": " "},
...
image_size_parameters = {
    "image_size_parameters": {"size_GB": {"arg": "-s", "val": "1G"}}
}
...
if __name__ == "__main__":
    ...
    ceph_version = subprocess.check_output(
        ["ceph", "--cluster", "{}".format(CLUSTER_NAME), "-v"]
    )
        ...
        for ITERATOR in range(0, 2):
            cmd(
                [
                    ...
                    + "testimg"
                    + str(ITERATOR),
                    "{}/".format(PATH) + "testimg" + str(ITERATOR),
                ]
            )
    ...
    cmd(
        [
            ...
            "{}/".format(PATH2) + "testimg" + str(ITERATOR),
            "{}/".format(PATH2) + "testimgex" + str(ITERATOR),
            "{}/".format(PATH) + "merge-diff-img" + str(ITERATOR),
        ]
    )
