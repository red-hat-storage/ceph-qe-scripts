"""
test_sync_post_service_stop_and_start.py
          - Test sync consistent with the multisite setup post making rgw service down 
            and renabling service up.

Usage : test_sync_post_service_stop_and_start.py -c <input_yaml>
<input_yaml>
    test_sync_consisitent_post_service_down_up_mero.yaml
