...
from v1.lib.s3.json_ops import JBucket
from v1.lib.s3.json_ops import JKeys
...
class BaseDir(object):
    ...
    def create(self, uname='default_user'):
        ...
        dirs = [os.path.abspath(
                self.mount_point + base_dir_name + str(i) + '.' + str(random.randint(1,1000)))
                for i in range(self.count)]

        [log.info('dir to create : %s' % dir)
         for dir in dirs]
            ...
            for key_info in key['keys']:
                ...
                if key_info['is_type'] == 'file':
                        ...
                        if op_code == 'move':
                            ...
                            cmd = 'sudo mv %s %s' %(os.path.abspath(local_key), os.path.abspath(new_key_path))
                            ...
                            if ret_val ==0 :
                                ...
                                key_info['opcode']['move']['old_name'] = key_info['key_name']
