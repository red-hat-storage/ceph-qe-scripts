...
class InstallOSP(object):
    ...
    def do_install(self):
        ...
        try:
            ...
            register_cmd = (
                "sudo subscription-manager register --username=%s --password=%s"
                % (self.user_name, self.passw)
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--pool_id",
        dest="pid",
        default="8a85f9823e3d5e43013e3ddd4e2a0977",
        help="Enter the RHEL Pool Id",
    )
    parser.add_argument(
        "-r", "--repo", dest="r", nargs="*", help="Enter RHEL Ceph RPMS"
    )
    parser.add_argument(
        "-u",
        "--username,",
        dest="u",
        default="qa@redhat.com",
        help="Enter QA the Username",
    )
    parser.add_argument(
        "-p",
        "--password",
        dest="p",
        default="a85xH8a5w8EaZbdS",
        help="Enter QA Password",
    )
