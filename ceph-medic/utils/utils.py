...
invalid_cmd_err = {
    "Invalid Inventory": {
        "Invalid inventory error": "--> the given inventory path does not exist: %s"
        % (invalid_inventory)
    },
    "Invalid SSH": {
        "Invalid ssh error": "--> the given ssh config path does not exist: %s"
        % (invalid_ssh)
    },
    "Invalid Invenotory and SSH": {
        "Invalid invenotory and ssh error": "--> the given ssh config path does not exist: %s"
        % (invalid_ssh)
    },
    "Invalid Command": {
        "Invalid command error": "Unknown command(s): %s" % (invalid_cmd)
    },
}
