...
class ErrrosCheckTest(object):
    def __init__(self, cluster_name):
        ...
        self.check_op = lambda error_code_to_check, cmd_output: True if error_code_to_check in cmd_output else False
    ...
    def check_and_revert(self, cmd_list, error_code_to_check, error_to_revert):
        ...
        try:
            ...
            cmd_output = subprocess.check_output(cmd_list).split()  # converting the output to list for parsing

            error_code_exixts = self.check_op(error_code_to_check, cmd_output)

            if not error_code_exixts:
                raise Exception, "Error code %s not exists,failed" % (error_code_to_check)
            else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('-cluster', dest="cluster_name",
                        help='Cluster name', default='ceph')
    ...
    ecom1.check_and_revert(cmd_list=cmd, error_code_to_check=ERRORS.common_errs['ECOM1']['error_code'],error_to_revert=revert.ecom1_err_revert)
    ...
    ecom2.check_and_revert(cmd_list=cmd, error_code_to_check=ERRORS.common_errs['ECOM2']['error_code'],error_to_revert=revert.ecom2_err_revert)
    ...
    ecom3.check_and_revert(cmd_list=cmd, error_code_to_check=ERRORS.common_errs['ECOM3']['error_code'],error_to_revert=revert.ecom3_err_revert)
    ...
    ecom4.check_and_revert(cmd_list=cmd, error_code_to_check=ERRORS.common_errs['ECOM4']['error_code'],error_to_revert=revert.ecom4_err_revert)
    ...
    ecom5.check_and_revert(cmd_list=cmd, error_code_to_check=ERRORS.common_errs['ECOM5']['error_code'],error_to_revert=revert.ecom5_err_revert)
    ...
    wmon1.check_and_revert(cmd_list=cmd, error_code_to_check=ERRORS.monitor_warnings['WMON1']['warning_code'],error_to_revert=revert.wmon1_revert)
    ...
    wmon2.check_and_revert(cmd_list=cmd, error_code_to_check=ERRORS.monitor_warnings['WMON2']['warning_code'],error_to_revert=None)
    ...
    wosd1.check_and_revert(cmd_list=cmd, error_code_to_check=ERRORS.monitor_warnings['WOSD1']['warning_code'],error_to_revert=revert.wosd1_revert)
    ...
    emon1.check_and_revert(cmd_list=cmd, error_code_to_check=ERRORS.monitor_err['EMON1']['error_code'],error_to_revert=revert.emon1_err_revert)